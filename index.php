...
<head>
	...
	<title> Andmetyybid(2) </title>
</head>

<body>
<h2>Arvutamine murd- ja t2isarvudega</h2>
<?php echo $float = 3.14; ?><br>
<?php echo $float + 7; ?><br>
<?php echo 4/3; ?>

<h2>Murdarvude ymardamine</h2>
<?php echo(round(3.14)); ?> <br>
<?php echo(ceil($float)); ?> <br>
<?php echo(floor($float)); ?> <br>
<h2> Andmetyybi funktsioonid </h2>
...
<?php $assoc = array("first_name" => "Anneli", "last_name" => "Loo"); ?>
<?php echo $assoc['first_name'];?> <br>
<?php echo $assoc['last_name'];?> <br>
 <?php $numbers = array(0 => 4, 5 => 8, 6 => 15, 9 => 16, 10 => 23, 15 => 42); ?>
<?php $assoc["age"] = 20; ?>
<?php $assoc["first_name"] = "Peeter" ?>
<?php echo $assoc['first_name'] = "Anneli";?> <br>
<?php echo $assoc['last_name'] = "Loo";?> <br>
<?php echo $assoc['e-mail'] = "anneli.loo@khk.ee";?> <br>
<?php echo $assoc['e-mail'] = "anneli.loo@khk.ee";?> <br>
